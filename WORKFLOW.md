...
| 5 | Portfolio-level vol target level (Phase 5) | Phase 5 | Not yet decided — 10% annualized floated as a starting point, needs validating against the Phase 2 signal(s)' actual realized vol |
